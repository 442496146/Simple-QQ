...
import com.mapper.FriendsRequestMapper;
import com.mapper.MyFriendsMapper;
import com.mapper.UsersMapper;
import com.mapper.UsersMapperCustom;
import com.netty.ChatMsg;
import com.netty.DataContent;
import com.netty.UserChannelRel;
import com.pojo.FriendsRequest;
...
public class UserServiceImpl implements UserService {
	...
	public Users saveUser(Users user) {
		...
		// 为每个用户生成一个唯一的二维码
		String qrCodePath = "/fastdfs/tmp/user" + userId + "qrcode.png";
//			String qrCodePath = "D:\\user" + userId + "qrcode.png";
	...
	public String saveMsg(ChatMsg chatMsg) {
		...
		com.pojo.ChatMsg msgDB = new com.pojo.ChatMsg();
	...
	@Transactional(propagation = Propagation.SUPPORTS)
	@Override
	public List<com.pojo.ChatMsg> getUnReadMsgList(String acceptUserId) {
		
		Example chatExample = new Example(com.pojo.ChatMsg.class);
		Criteria chatCriteria = chatExample.createCriteria();
		chatCriteria.andEqualTo("signFlag", 0);
		chatCriteria.andEqualTo("acceptUserId", acceptUserId);
		
		List<com.pojo.ChatMsg> result = chatMsgMapper.selectByExample(chatExample);
